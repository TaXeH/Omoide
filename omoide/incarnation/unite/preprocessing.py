...
from omoide import constants, essence, rite
from omoide.incarnation import unite
from omoide.essence import transient
from omoide.incarnation.unite import ephemeral, persistent
...
def do_groups(source: ephemeral.Source,
              ...
              leaf_folder: str,
              renderer: essence.Renderer) -> None:
    """Construct transient entities from ephemeral ones."""
