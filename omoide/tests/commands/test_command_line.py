...
def test_unite():
    ...
    assert cmd1.name == 'unite'
    assert cmd1.branch == 'all'
    assert cmd1.leaf == 'all'
    assert cmd1.sources_folder == constants.DEFAULT_SOURCES_FOLDER
    assert cmd1.content_folder == constants.DEFAULT_CONTENT_FOLDER
...
#     cmd, op = command_line.parse_arguments(['make_migrations',
#                                             '--sources', 'test1',
...
#     cmd, op = command_line.parse_arguments(['migrate',
#                                             '--sources', 'test1',
#                                             '--content', 'test2'], None, None)
#
#     assert cmd == 'migrate'
...
#     with pytest.raises(ValueError, match=msg):
#         command_line.parse_arguments(['migrate', '--sources', 'test1',
#                                       '--content'], None, None)
#
#
# def test_sync_all():
#     cmd, op = command_line.parse_arguments(['sync'], None, None)
#
#     assert cmd == 'sync'
...
#     cmd, op = command_line.parse_arguments(['sync', 'branch', 'test1'], None,
#                                            None)
#
#     assert cmd == 'sync'
#     assert isinstance(op, commands.SyncCommand)
...
#
# def test_sync_leaf():
#     cmd, op = command_line.parse_arguments(['sync', 'leaf', 'test2'], None,
#                                            None)
#
#     assert cmd == 'sync'
#     assert isinstance(op, commands.SyncCommand)
...
#     with pytest.raises(ValueError, match=msg):
#         command_line.parse_arguments(['sync', 'wtf', 'test2'], None, None)
#
#
...
#     with pytest.raises(ValueError, match=msg):
#         command_line.parse_arguments(['sync', 'wtf'], None, None)
#
#
# def test_runserver_bare():
#     cmd, op = command_line.parse_arguments(['runserver'], None, None)
#
...
#     cmd, op = command_line.parse_arguments(['runserver', '8888'], None, None)
#
#     assert cmd == 'runserver'
#     assert isinstance(op, commands.RunserverCommand)
#     assert op.host == constants.DEFAULT_SERVER_HOST
...
#     cmd, op = command_line.parse_arguments(['runserver', '192.168.1.67:8888'],
#                                            None, None)
#
#     assert cmd == 'runserver'
#     assert isinstance(op, commands.RunserverCommand)
...
#     with pytest.raises(ValueError, match=msg):
#         command_line.parse_arguments(['runserver', '192.168.1.67:xxx'], None,
#                                      None)
#
#
